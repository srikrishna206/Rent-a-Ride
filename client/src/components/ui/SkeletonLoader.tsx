...
const SkeletonLoader = () => {
    return (
        <div className="flex flex-row flex-wrap  justify-between items-center gap-6 p-4 w-full">
        {Array.from({ length: 12 }).map((_, index) => (
          <div
            key={index}
            className="bg-white dark:bg-gray-300 shadow-md rounded-lg p-10 w-[250px] md:w-[300px] animate-pulse"
          >
            {/* Skeleton Image */}
