...
import { setVehicleDetail, showVehicles } from "../../redux/user/listAllVehicleSlice";
          ...
          <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="text-[14px]  flex flex-col items-end">
                ...
                <div className="text-[6px] relative bottom-[3px]">Per Day</div> 
              </div>
            </div>

            <div className="my-2 font-mono">
             <div className="flex justify-between items-center mb-5 mt-5">
              <h3 className="text-[12px] flex justify-between items-center gap-1 "><span><FaCarSide /></span>{cur.company}</h3>
              <p className=" text-end text-[12px] flex justify-between items-center gap-1"><span><MdAirlineSeatReclineNormal /></span>{cur.seats}</p>
             </div>
             <div className="flex justify-between items-center text-[12px] mb-5 ">
              <p className="flex items-center justify-center gap-1"><FaCarSide />{cur.car_type}</p>
              <p className="flex justify-between items-center gap-1"><span><BsFillFuelPumpFill /></span>{cur.fuel_type}</p>
             </div>
            ...
            <button className="bg-green-500 px-4 py-2 rounded-sm" onClick={()=> onVehicleDetail(cur._id)}>
              <div>Book Ride</div>
             </button>
            </Link>
