...
const AvailableVehiclesAfterSearch = () => {
  ...
  return (
    <div>
      {availableCars && availableCars.length>0 && <div className="text-center flex flex-col  mt-10 justify-center items-center sm:max-w-[500px] mx-auto">
    ...
    </div>{!availableCars || availableCars.length==0 && <CarNotFound/>}
